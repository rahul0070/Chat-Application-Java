...
public class AverageTimeGraph extends Application {
...

    {
        ...
        secondpart2.add(res[2]);
                ...
                double [] client_id = new double[1000]  ;
                double[] totalsecondsender = new double[1000]  ;
                double[] totalsecondreceiver = new double[1000]  ;
        ...
        series.getData().add(new XYChart.Data(c[5], d[5]));
        series.getData().add(new XYChart.Data(c[6], d[6]));
        series.getData().add(new XYChart.Data(c[7], d[7]));
        series.getData().add(new XYChart.Data(c[8], d[8]));
        series.getData().add(new XYChart.Data(c[9], d[9]));
        series.getData().add(new XYChart.Data(c[10],d[10]));
